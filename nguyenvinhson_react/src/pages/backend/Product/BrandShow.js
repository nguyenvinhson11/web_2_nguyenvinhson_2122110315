          ...
          <table className="w-full table-auto border text-sm text-gray-800">
            <tbody>
              ...
              <tr className="bg-gray-100">
                ...
                <td className="border p-3">{brand.createdBy ?? "Không rõ"}</td>
              </tr>
              <tr>
                <td className="font-semibold border p-3">Người cập nhật</td>
                <td className="border p-3">{brand.updatedBy ?? "Không rõ"}</td>
              </tr>
              <tr className="bg-gray-100">
                <td className="font-semibold border p-3">Người xóa</td>
                <td className="border p-3">{brand.deletedBy ?? "Không rõ"}</td>
              </tr>
              <tr>
